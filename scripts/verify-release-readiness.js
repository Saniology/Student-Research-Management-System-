...
function checkReleaseDocs() {
  ...
  assertContains('docs/release-checklist.md', /npm run verify:dr/, 'release checklist includes disaster recovery verifier');
  assertContains('docs/release-checklist.md', /npm run verify:governance/, 'release checklist includes data governance verifier');
  ...
  assertContains('docs/release-checklist.md', /npm run verify:playwright/, 'release checklist includes Playwright role gate');
  ...
  assertContains('docs/production-deployment-runbook.md', /disaster-recovery-runbook\.md/, 'production runbook links disaster recovery guide');
  assertContains('docs/production-deployment-runbook.md', /data-governance-privacy-runbook\.md/, 'production runbook links data governance guide');
  ...
  assertContains('docs/production-deployment-runbook.md', /production-monitoring-runbook\.md/, 'production runbook links monitoring guide');
  ...
  assertContains('docs/local-development-setup.md', /npm run verify:dr/, 'local setup includes disaster recovery verifier');
  assertContains('docs/local-development-setup.md', /npm run verify:governance/, 'local setup includes data governance verifier');
  ...
  assertContains('docs/local-development-setup.md', /npm run verify:playwright/, 'local setup includes Playwright role verifier');
  ...
  assertContains('.github/workflows/verify.yml', /npm run verify:playwright/, 'GitHub Actions includes Playwright role gate');
  assertContains('.github/workflows/verify.yml', /npm run verify:db/, 'GitHub Actions includes database gate');
  assertContains('.github/workflows/verify.yml', /npm run verify:dr/, 'GitHub Actions includes disaster recovery gate');
  assertContains('.github/workflows/verify.yml', /npm run verify:governance/, 'GitHub Actions includes data governance gate');
  ...
  assertContains('.github/workflows/verify.yml', /npm run verify:monitor/, 'GitHub Actions includes monitoring gate');
