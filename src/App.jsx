...
function Landing({ tenant, session, onLogin, onWorkspace, onDownload, configError }) {
  ...
  return <div className="blueprint">
    {configError && <div className="config-alert" id="app-config-error" role="alert"><Settings2 size={16} /><span>Browser configuration is incomplete. Add the public Supabase URL and anon key in <code>js/config.js</code> before signing in or submitting.</span></div>}
